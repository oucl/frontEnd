> 关于webApp自己一直想做，于是在2018年6月学习vue时很感兴趣，于是写了这么一个仿写页面, 在这里和大家分享一下
...
```
## 项目截图
<img src="./static/projectScreenshots/1.png" width="20%"/>&nbsp;&nbsp;&nbsp;&nbsp;
<img src="./static/projectScreenshots/2.png" width="20%"/>&nbsp;&nbsp;&nbsp;&nbsp;
<img src="./static/projectScreenshots/3.png" width="20%"/>&nbsp;&nbsp;&nbsp;&nbsp;
<img src="./static/projectScreenshots/4.png" width="20%"/>

## 声明

本项目的设计部分参考<a href="https://coding.imooc.com/class/74.html" target=_blank>慕课网</a>，但慕课网采用的是vue1.0开发，本项目采用vue2.0重构，并且引入vuex、vue-router等插件，是我个人的练手项目，如有冒犯，还请海涵，联系删除。
